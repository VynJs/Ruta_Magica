class Entretenimiento:
    ...
    def mostrar_info(self):
            return f"ID: {self.id}, Nombre :{self.nombre_entretenimiento}, Categoria: {self.categoria}, Horario : {self.horario_inicio}, - {self.horario_fin},  Dirección: {self.direccion}, Mapa: {self.longitud}, - {self.latitud}, Nombre del responsable: {self.nombre_responsable}, Telefono:{self.telefono}, Correo: {self.correo}, Descripción corta: {self.descripcion_corta}, Descripción completa:{self.descripcion_completa}, Caracteristica 1: {self.caracteristica_1}, Caracteristica 2: {self.caracteristica_2}, Caracteristica 3: {self.caracteristica_3}, Capacidad: {self.capacidad}, Precios: {self.precio}, Servicio 1:{self.servicio_1}, Servicio 2:{self.servicio_2}, Servicio 3:{self.servicio_3}, Servicio 4:{self.servicio_4}, Servicio 5:{self.servicio_5}, Recomendacion 1: {self.recomendacion_1}, Recomendacion 2: {self.recomendacion_2}, Recomendacion 3: {self.recomendacion_3}, Recomendacion 4: {self.recomendacion_4},  Instagram: {self.instagram}, FacebooK: {self.facebook}, Pagina Web: {self.pagina_web}" 