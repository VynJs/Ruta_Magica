class Entretenimiento:
    ...
    def _init_(self, id, nombre_entretenimeinto, categoria, horario_inicio, horario_fin, direccion, mapa, nombre_responsable, telefono, correo, descripcion_corta, descripcion_completa, caracteristica_1, caracteristica_2, caracteristica_3, capacidad, precio, servicio_1, servicio_2, servicio_3, servicio_4, servicio_5, recomendacion_1, recomendacion_2, recomendacion_3,recomendacion_4, instagram, facebook, pagina_web):
        self.id = id
